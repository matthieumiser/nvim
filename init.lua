...
vim.opt.smarttab = true -- Insert spaces when pressing Tab
...
vim.api.nvim_create_autocmd('FileChangedShellPost', {
  ...
  desc = 'Automatically reload the file if changed externally',
})
...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Add jdtls to servers table for mason-lspconfig to handle
      servers.jdtls = {}

      -- Use mason-lspconfig to set up servers with the new vim.lsp API
